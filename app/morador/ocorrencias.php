...
<body class="bg-slate-50 font-sans min-h-screen flex flex-col md:flex-row">
    ...
    <aside id="mobile-menu" class="hidden md:flex flex-col w-full md:w-64 bg-green-700 text-white shadow-xl h-auto md:h-screen sticky top-0 z-40 md:z-auto transition-all">
        ...
        <nav class="flex-1 p-2 md:p-4 space-y-1">
            <a href="index.php" class="flex items-center gap-3 p-3 rounded-lg hover:bg-green-600 text-green-100 transition-colors">
                <i class="fa-solid fa-house w-6 text-center"></i> Início
            </a>
            <a href="avisos.php" class="flex items-center gap-3 p-3 rounded-lg hover:bg-green-600 text-green-100 transition-colors">
                <i class="fa-solid fa-bell w-6 text-center"></i> Avisos
            </a>
            <a href="reservas.php" class="flex items-center gap-3 p-3 rounded-lg hover:bg-green-600 text-green-100 transition-colors">
                <i class="fa-solid fa-calendar-check w-6 text-center"></i> Reservas
            </a>
            <a href="ocorrencias.php" class="flex items-center gap-3 p-3 bg-green-800 text-green-50 rounded-lg transition-colors font-medium">
